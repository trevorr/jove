 ...
 */
public final class JavaBreakStatement
    extends JavaStatement
    implements BreakStatement
{
    private final JavaLabeledStatement target;

    public JavaBreakStatement(JavaSchema schema, JavaLabeledStatement target)
    {
        super(schema);
        this.target = target;
    }

    public JavaBreakStatement(JavaSchema schema)
    {
        this(schema, null);
    }
