 ...
 */
public final class JavaReturnStatement
    extends JavaStatement
    implements ReturnStatement
{
    private final JavaExpression returnValue;

    public JavaReturnStatement(JavaSchema schema, JavaExpression returnValue)
    {
        super(schema);
        this.returnValue = returnValue;
    }

    public JavaReturnStatement(JavaSchema schema)
    {
        this(schema, null);
    }

    public JavaExpression getReturnValue()
    {
        return returnValue;
    }
