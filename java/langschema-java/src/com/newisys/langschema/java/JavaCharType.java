...
/**
 * Represents the Java char type.
 * 
 * @author Trevor Robinson
 */
public final class JavaCharType
    extends JavaIntegralType
{
    JavaCharType(JavaSchema schema)
    {
        super(schema, 16, false);
    }

    public boolean isSubtype(JavaType type)
    {
        final JavaPrimitiveType primType = unbox(type);
        return primType != null && isCharSubtype(primType);
    }
