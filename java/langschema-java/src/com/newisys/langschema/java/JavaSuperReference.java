...
/**
 * Represents a Java super-type reference.
 * 
 * @author Trevor Robinson
 */
public final class JavaSuperReference
    extends JavaExpression
    implements SuperReference
{
    private final JavaAbstractClass type;

    public JavaSuperReference(JavaAbstractClass type)
    {
        super(type.getSchema());
        assert (type.getBaseClass() != null);
        this.type = type;
    }
