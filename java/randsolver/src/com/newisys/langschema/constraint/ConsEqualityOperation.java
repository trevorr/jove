...
public abstract class ConsEqualityOperation
    extends ConsBinaryOperation
{
    public ConsEqualityOperation(ConsExpression op1, ConsExpression op2)
    {
        super(op1, op2);
        JavaType type1 = op1.getResultType();
        JavaType type2 = op2.getResultType();
        assert ((schema.isDVNumeric(type1) && schema.isDVNumeric(type2)) || ((type1 instanceof JavaStructuredType || type1 instanceof JavaNullType) && (type2 instanceof JavaStructuredType || type2 instanceof JavaNullType)));
    }
