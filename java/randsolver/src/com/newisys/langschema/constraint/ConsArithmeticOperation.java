...
public abstract class ConsArithmeticOperation
    extends ConsBinaryOperation
{
    private final JavaType resultType;

    public ConsArithmeticOperation(ConsExpression op1, ConsExpression op2)
    {
        super(op1, op2);
        JavaType type1 = op1.getResultType();
        JavaType type2 = op2.getResultType();
        assert (schema.isDVNumeric(type1) && schema.isDVNumeric(type2));
        resultType = schema.promote(type1, type2);
    }
