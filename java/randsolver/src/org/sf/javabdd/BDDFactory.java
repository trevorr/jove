...
/*
 * Modified by Jon Nall 03-Feb-2005
 */
...
public abstract class BDDFactory
{
     ...
     * operation cache size. Tries to use the "buddy" native library; if it
     * fails, it falls back to the "java" library.
     *
     ...
     * "buddy", "cudd", "java", "test", or a name of a class that has an init()
     * method that returns a BDDFactory. If it fails, it falls back to the
     * "java" factory.
     *
     ...
     * true and false). The requested variable must be in the (zero-indexed)
     * range defined by setVarNum.
     *
    ...
    /**
     * Returns the number of allowed reorderings left. This value can be defined
     * by autoReorder.
     *
     ...
     * current number of variables is 3 and neworder contains [1; 0; 2] then the
     * new variable order is v1 <v0 <v2.
     *
     * @param neworder
     */
    ...
    public int[] makeVarOrdering(boolean reverseLocal, String ordering)
    {
        ...
        for (int i = 0;; ++i)
        {
            ...
            bitIndex = fillInVarIndices(doms, i - numberOfDomains,
                numberOfDomains + 1, localOrders, bitIndex, varorder);
            if (!st.hasMoreTokens())
            {
                break;
            }
     ...
     * No reordering.
     */
    public static final ReorderMethod REORDER_NONE = new ReorderMethod(0,
        "NONE");
    /**
     * Reordering using a sliding window of 2.
     */
    public static final ReorderMethod REORDER_WIN2 = new ReorderMethod(1,
        "WIN2");
    /**
     * Reordering using a sliding window of 2, iterating until no further
     * progress.
     */
    public static final ReorderMethod REORDER_WIN2ITE = new ReorderMethod(2,
        "WIN2ITE");
    /**
     * Reordering using a sliding window of 3.
     */
    public static final ReorderMethod REORDER_WIN3 = new ReorderMethod(5,
        "WIN3");
    /**
     * Reordering using a sliding window of 3, iterating until no further
     * progress.
     */
    public static final ReorderMethod REORDER_WIN3ITE = new ReorderMethod(6,
        "WIN3ITE");
    /**
     ...
     * but good method.
     */
    public static final ReorderMethod REORDER_SIFT = new ReorderMethod(3,
        "SIFT");
    /**
     * Same as REORDER_SIFT, but the process is repeated until no further
     * progress is done. Can be extremely slow.
     */
    public static final ReorderMethod REORDER_SIFTITE = new ReorderMethod(4,
        "SIFTITE");
    /**
     * Selects a random position for each variable. Mostly used for debugging
     * purposes.
     */
    public static final ReorderMethod REORDER_RANDOM = new ReorderMethod(7,
        "RANDOM");
