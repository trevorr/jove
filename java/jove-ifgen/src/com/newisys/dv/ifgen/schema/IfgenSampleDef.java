...
/**
 * Ifgen schema object for sample definitions.
 * 
 * @author Trevor Robinson
 * @author Jon Nall
 */
public final class IfgenSampleDef
    extends IfgenSchemaObject
    implements IfgenEdgeDef, IfgenInterfaceMember
{
    private static final long serialVersionUID = 3618414921604217141L;

    private IfgenEdge edge;
    private int skew;

    public IfgenSampleDef(IfgenSchema schema, IfgenEdge edge, int skew)
    {
        super(schema);
        this.edge = edge;
        this.skew = skew;
    ...
    {
        if (obj instanceof IfgenSampleDef)
        {
            IfgenSampleDef other = (IfgenSampleDef) obj;
