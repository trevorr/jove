...
/**
 * Base class for named testbench members.
 * 
 * @author Jon Nall
 */
public abstract class IfgenNamedTestbenchMember
    extends IfgenTestbenchMember
    implements NamedObject
{
    private final IfgenName name;

    protected IfgenNamedTestbenchMember(IfgenSchema schema, IfgenName name)
    {
        super(schema);
        this.name = name;
    }
