...
/**
 * Visitor over Jove schema types.
 * 
 * @author Trevor Robinson
 */
public interface JoveTypeVisitor
    extends JavaTypeVisitor
{
    void visit(JoveAssocArrayType obj);

    void visit(JoveBitVectorType obj);

    void visit(JoveFixedArrayType obj);
}
