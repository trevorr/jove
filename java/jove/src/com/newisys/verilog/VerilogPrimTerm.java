...
/**
 * Represents a primitive terminal.
 * 
 * @author Trevor Robinson
 */
public interface VerilogPrimTerm
    extends VerilogDeclObject, VerilogNetLoad, VerilogRegLoad,
    VerilogNetDriver, VerilogReadValue
{
    // properties
    int getIndex();
