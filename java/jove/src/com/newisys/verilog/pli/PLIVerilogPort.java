...
/**
 * PLI implementation of VerilogPort.
 * 
 * @author Trevor Robinson
 */
public final class PLIVerilogPort
    extends PLIVerilogPorts
    implements VerilogPort
{
    public PLIVerilogPort(PLIInterface pliIntf, long handle)
    {
        super(pliIntf, PLIObjectType.PORT, handle);
    }

    public final int getPortIndex()
    {
        return pliIntf
            .getPropInt(PLIPropertyTypeConstants.vpiPortIndex, handle);
    }
    ...
    public final Iterator<VerilogPortBit> getBits()
    {
