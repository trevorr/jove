...
/**
 * Represents a module parameter declaration.
 * 
 * @author Trevor Robinson
 */
public interface VerilogParameter
    extends VerilogAbsVar, VerilogReadValue
{
    // properties
    ConstType getConstType();

    // objects
    VerilogModule getModule();

    VerilogScope getScope();
