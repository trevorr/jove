...
/**
 * Represents a definition of a user-defined primitive (UDP).
 * 
 * @author Trevor Robinson
 */
public interface VerilogUdpDefn
    extends VerilogDeclObject
{
    ...
    Iterator<VerilogTableEntry> getTableEntries();

    VerilogInitial getInitial();
}
