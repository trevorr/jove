...
/**
 * Represents the common features of a port or port bit.
 * 
 * @author Trevor Robinson
 */
public interface VerilogPorts
    extends VerilogDeclObject, VerilogNetDriver
{
    // properties
    boolean isScalar();
    ...
    VerilogExpr getHighConn();

    VerilogExpr getLowConn();
}
