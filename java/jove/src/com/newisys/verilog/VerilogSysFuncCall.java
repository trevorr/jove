...
/**
 * Represents a system function call.
 * 
 * @author Trevor Robinson
 */
public interface VerilogSysFuncCall
    extends VerilogTfCall, VerilogExpr, VerilogReadValue, VerilogWriteValue
{
    // properties
    FuncType getFuncType();

    // objects
    VerilogUserSystf getUserSystf();
}
