...
/**
 * Represents a timing check.
 * 
 * @author Trevor Robinson
 */
public interface VerilogTchk
    extends VerilogDeclObject
{
    // properties
    TchkType getTchkType();
    ...
    VerilogExpr getNotifier();

    VerilogExpr getDelay();

    Iterator<VerilogTchkTerm> getRefTerms();

    Iterator<VerilogTchkTerm> getDataTerms();
}
