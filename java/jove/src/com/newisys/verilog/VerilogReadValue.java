...
/**
 * Represents an object with a readable value.
 * 
 * @author Trevor Robinson
 */
public interface VerilogReadValue
    extends VerilogObject
{
    int getSize();

    Object getValue();

    Object getValue(ValueType type);

    VerilogCallback addValueChangeCallback(VerilogCallbackHandler handler);

    VerilogCallback addValueChangeCallback(
        TimeType timeType,
        ValueType valueType,
