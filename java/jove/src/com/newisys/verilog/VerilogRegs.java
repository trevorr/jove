...
/**
 * Represents the common features of a register or register bit.
 * 
 * @author Trevor Robinson
 */
public interface VerilogRegs
    ...
    VerilogWriteValueForce
{
    ...
    Iterator<VerilogRegDriver> getDrivers();

    Iterator<VerilogRegLoad> getLoads();
}
