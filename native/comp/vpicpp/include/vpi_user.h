...
/* the following are for System Verilog */
#define vpiChar		     71   /* char data type */
#define vpiShortInt	     72   /* shortint data type */
#define vpiLongInt	     73   /* longint data type */
#define vpiByte		     74   /* byte data type */
#define vpiBitT		     75   /* scalar or vector bit */
#define vpiBitTBit	     76   /* bit of vector bit type */
#define vpiLogic	     77   /* scalar or vector logic */
#define vpiLogicBit	     78   /* bit of vector logic */
#define vpiIntVar	     79   /* int variable */
#define vpiStructure	     80   /* structure */
#define vpiUnion	     90   /* union */
#define vpiStringVar	     91	  /* string variable */
...
#define vpiPassByRef          6   /* by reference */
...
/***************************** Configure Types *****************************/
#define vpiDisplayErrors        1
#define vpiDisplayWarnings      2
...
XXTERN PLI_INT32  vpi_chk_error       PROTO_PARAMS((p_vpi_error_info
                                                      error_info_p));
XXTERN PLI_INT32  vpi_configure       PROTO_PARAMS((PLI_INT32 item,
                                                      PLI_BYTE8 *value));
